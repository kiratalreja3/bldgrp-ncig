...
#File Locations
#INPUT_FASTA=fasta files from flye
#INPUT_REF="/g/data/te53/sj2852/blgrp/referenceresource/chm13-t2t.ebv.phix.chrQ.xy.fa"
#OUTPUT_DIR="/g/data/te53/sj2852/blgrp/analyses/flye_assemblies/NEW_FLYE
...
usage() {
        echo "Usage: qsub -v INPUT_FASTA=input.flyeasm.fasta,INPUT_REF=input.ebv.phix.chrQ.xy.fa.mm2idx,OUTPUT_DIR=outdir,SAMPLEID=sampleid /g/data/te53/sj2852/blgrp/scripts/run_and_submit_scripts/runminimap2_grch38.sh" >&2
        echo
        exit 1
}
